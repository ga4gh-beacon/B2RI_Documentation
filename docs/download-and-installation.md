...
### Data ingestion tools
  ...
  We will download the data ingestion tools from [this](https://github.com/EGA-archive/beacon2-ri-tools) repository. Please follow the instructions provided in the [README](https://github.com/EGA-archive/beacon2-ri-tools/blob/main/README.md).
 
The data ingestion toolkit needs **external software** to function. Even if you have them in your system, we recommend downloading them for the sake of **consistency** of versions. We need:
...
We're going to install it by using a [Docker](https://docs.docker.com/) container. You need to have `docker` and `docker-compose` installed.
...
Once installed you should two Docker processes: ```mongo``` and ```mongo-express```. You can check this by typing:
